...
var localAuthentication_guard_1 = require("./localAuthentication.guard");
var jwt_authentication_guard_1 = require("./jwt-authentication.guard");
var AuthenticationController = /** @class */ (function () {
    function AuthenticationController(authenticationService) {
        this.authenticationService = authenticationService;
    }
    AuthenticationController.prototype.register = function (registrationData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.authenticationService.register(registrationData)];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.authenticationService.getCookieWithJwtToken(user.id)];
                    case 1:
                        cookie = _a.sent();
    ...
    AuthenticationController.prototype.authenticate = function (request) {
    ...
    __decorate([
        ...
        (0, common_1.Get)(),
        __param(0, (0, common_1.Req)())
    ], AuthenticationController.prototype, "authenticate");
