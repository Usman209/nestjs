...
var JwtStrategy = /** @class */ (function (_super) {
    ...
    function JwtStrategy(configService, userService) {
        var _this = _super.call(this, {
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromExtractors([function (request) {
                    var _a;
    ...
    JwtStrategy.prototype.validate = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.getById(payload.userId)];
            });
        });
    };
